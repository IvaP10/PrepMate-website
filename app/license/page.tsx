    ...
    >
      <section className="prose-card">
        ...
        <div className="resource-links">
          <a className="resource-link" href="/LICENSE">Read LICENSE <span>↗</span></a>
          <a className="resource-link" href="/NOTICE">Read NOTICE <span>↗</span></a>
          <a className="resource-link" href="/THIRD_PARTY_NOTICES.md">Read third-party notices <span>↗</span></a>
        </div>
